	...
	return (
		...
		>
			...
			<div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
				<div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] lg:w-[35%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
					<div>
						<div className="flex w-full items-center justify-between">
							<Link href="/">
								<Image src="/../public/assets/logo.png" width="60" height="24" alt="/" />
							</Link>
					...
					<div className="py-4 flex flex-col">
						...
						<div className="pt-40">
							...
							<div className="flex py-6 items-center justify-between my-4 w-full sm:w-[80%]">
